...
fetchDataFromServer(`https://api.themoviedb.org/3/genre/movie/list?api_key=${api_key}`, function ({ genres }) {
  ...
  fetchDataFromServer(`https://api.themoviedb.org/3/movie/popular?api_key=${api_key}&page=5`, heroBanner);
});
...
const heroBanner = function ({ results: movieList }) {
  ...
  for (const { title, path } of homePageSections) {
    fetchDataFromServer(`https://api.themoviedb.org/3${path}?api_key=${api_key}&page=2`, createMovieList, title);
  }
